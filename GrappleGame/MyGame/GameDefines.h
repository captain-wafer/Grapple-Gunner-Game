...
enum class eSprite: UINT{
  Background, Bullet, Bullet2, Player, Turret, Smoke, Spark, Tile, Line, Spike, Door,
  Standright, Standleft, Walkright, Walkleft, Jump, Star, Bat, Swooper, LaunchPad, Grappler, 
  Win, Lose, DoorOpen, HealthPack, OneUp, HealthBar_Green, HealthBar_Red, Shotgun,
  Creeper, CreeperExplosion,
  Size  //MUST BE LAST
}; //eSprite
...
enum class eSound: UINT{
  Start, Boom, Clang, Grunt, Gun, Ricochet, Star, PowerDown, Bounce,
  Size  //MUST BE LAST
}; //eSound
